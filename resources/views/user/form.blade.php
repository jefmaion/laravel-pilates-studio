<div class="row">
    ...
    <div class="col-3 form-group">
        ...
        <x-form.input type="text" class="viacep-loading" name="complement" value="{{ old('complement', $user->complement) }}" />
    </div>

    <div class="col-7 form-group">
        <label>Bairro</label>
        <x-form.input type="text" class="viacep-loading" name="district" value="{{ old('district', $user->district) }}" />
    </div>
    ...
    <div class="col-3 form-group">
        ...
        <x-form.input type="text" class="sp_celphones" name="phone_wpp" value="{{ old('phone_wpp', $user->phone_wpp) }}" />
    </div>
